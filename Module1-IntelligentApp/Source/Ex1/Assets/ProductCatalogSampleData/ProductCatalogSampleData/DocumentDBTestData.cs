...
{
    public static class DocumentDBTestData
    {
        public static async Task InitializePartsUnlimitedDatabaseAsync(string documentDbName, string documentDbEndpoint, string documentDbAuthKey, string documentDbCollection)
        {
            var productsRepository = new ProductsRepository(documentDbEndpoint, documentDbAuthKey, documentDbName, documentDbCollection);

            bool documentDBEmpty = !productsRepository.Set<Product>().ToList().Any();

            if (documentDBEmpty)
            {
                await InsertDocumentDBTestData(productsRepository);
            }

        }

        private static async Task InsertDocumentDBTestData(IProductsRepository productsRepository)
        {
        ...
        {
            yield return new Category { CategoryId = 1, Name = "Brakes", Description = "Brakes description", ImageUrl = "product_brakes_disc.jpg" };
            yield return new Category { CategoryId = 2, Name = "Lighting", Description = "Lighting description", ImageUrl = "product_lighting_headlight.jpg" };
            yield return new Category { CategoryId = 3, Name = "Wheels & Tires", Description = "Wheels & Tires description", ImageUrl = "product_wheel_rim.jpg" };
            yield return new Category { CategoryId = 4, Name = "Batteries", Description = "Batteries description", ImageUrl = "product_batteries_basic-battery.jpg" };
            yield return new Category { CategoryId = 5, Name = "Oil", Description = "Oil description", ImageUrl = "product_oil_premium-oil.jpg" };
        }
